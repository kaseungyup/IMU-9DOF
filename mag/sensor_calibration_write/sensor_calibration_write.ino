...
void setup() {
  ...
  // in uTesla
  cal.mag_hardiron[0] = -38.08;
  cal.mag_hardiron[1] = 13.33;
  cal.mag_hardiron[2] = -6.97;

  // in uTesla
  cal.mag_softiron[0] = 0.992;
  cal.mag_softiron[1] = 0.045;
  cal.mag_softiron[2] = -0.002;  
  cal.mag_softiron[3] = 0.045;
  cal.mag_softiron[4] = 1.015;
  cal.mag_softiron[5] = 0.014;  
  cal.mag_softiron[6] = -0.002;
  cal.mag_softiron[7] = 0.014;
  cal.mag_softiron[8] = 0.995;
  ...
  cal.mag_field = 44.45; // approximate value for locations along the equator

  // in Radians/s
  cal.gyro_zerorate[0] = 0.0086;
  cal.gyro_zerorate[1] = -0.0024;
  cal.gyro_zerorate[2] = -0.0043;

  cal.accel_zerog[0] = -0.03;
  cal.accel_zerog[1] = 0.04;
  cal.accel_zerog[2] = -0.06;
